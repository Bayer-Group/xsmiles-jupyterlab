...
# -*- coding: utf-8 -*-
#
# xsmiles documentation build configuration file
#
...
_version_py = os.path.join(repo, 'xsmiles', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'xsmiles.tex', 'xsmiles Documentation',
     'Bayer AG', 'manual'),
]
